...
from timessim.utils.utils_for_tb_ualoha_with_dqn import get_max_index
from timessim.utils.plot_rewards_per_n_ue import plot_rewards_per_n_ue, plot_actions_per_n_ue
...
final_file_name_output_1 = 'timessim/results/' + f'{year}_{month:02d}_{day:02d}_' + 'TB_output_dict' + '_final_UEs_' + str(final_number_of_ues) + '_Payload_' + str(payload_fq)+ '_contention_window_' + str(contention_window_int) + '_buffer_size_' + str(max_n_packets_to_be_forwarded) + '_TTL_' + str(TTL) + 'discarded_pck' + '.txt'
final_file_name_output_2 = 'timessim/results/' + f'{year}_{month:02d}_{day:02d}_' + 'TB_averaged_data' + '_final_UEs_' + str(final_number_of_ues) +'_Payload_' + str(payload_fq)+ '_contention_window_' + str(contention_window_int) + '_buffer_size_' + str(max_n_packets_to_be_forwarded) + '_TTL_' + str(TTL) + 'discarded_pck' + '.txt'
final_file_name_output_3 = 'timessim/results/' + f'{year}_{month:02d}_{day:02d}_' + 'TB_inputs' + '_final_UEs_' + str(final_number_of_ues) + '_Payload_' + str(payload_fq)+ '_contention_window_' + str(contention_window_int) + '_buffer_size_' + str(max_n_packets_to_be_forwarded) + '_TTL_' + str(TTL) + 'discarded_pck' + '.txt'
