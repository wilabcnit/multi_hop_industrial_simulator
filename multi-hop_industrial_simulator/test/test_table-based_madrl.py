...
from timessim.scheduler.DQN_agent_rl_mesh import epsilon_greedy_policy, training_step, get_model, get_dueling_model, \
...
from timessim.utils.choose_next_action_Q_and_W import  choose_next_action_tb_only_W, choose_next_action_tb_only_Q
...
# Fucntion to move to the RX_ACK for the BS
...
# Function to create the simulato timing structure
    ...
    for n_ue_index, n_ue in enumerate(range(initial_number_of_ues, final_number_of_ues + 1, step_number_of_ues)):
        ...
        for ue in ue_array:
            plot_rewards_per_n_ue(input_ue_id=ue.get_ue_id(),
                                  ...
                                  input_n_ue=n_ue,
                                  input_save_path='timessim/results/plot_results/Q_and_W_only_W' + path + f"seed_{seed}")
            plot_rewards_per_n_ue(input_ue_id=ue.get_ue_id(),
                                  input_ue_simulations_reward=ue.get_Q_simulations_reward(),
                                  input_n_ue=n_ue,
                                  input_save_path='timessim/results/plot_results/Q_and_W_only_Q' + path + f"seed_{seed}")
            ...
            #                       input_n_ue=n_ue,
            #                       input_save_path='timessim/results/plot_results/v6_' + path + f"seed_{seed}")
...
final_file_name_output_1 = 'timessim/results/' + path + f'{year}_{month:02d}_{day:02d}_' + 'TB_output_dict' + '_final_UEs_' + str(
...
final_file_name_output_2 = 'timessim/results/' + path + f'{year}_{month:02d}_{day:02d}_' + 'TB_averaged_data' + '_final_UEs_' + str(
    final_number_of_ues) + '_Payload_' + str(payload_fq) + "_TTL_" + str(TTL) + '_TX_per_action_' + str(number_of_tx_data_per_step) + '_TTL_' + str(TTL) + '_goal_oriented_' + str(goal_oriented) + '_normalized_S_' + str(normalized_S) + "_discarded_pck" + "_skip_config_" + str(skip_config) + "_portion_time_1_over_" + str(skip_config_portion_time) +  '_Q_and_W_replay_not_split.txt'
final_file_name_output_3 = 'timessim/results/' + path + f'{year}_{month:02d}_{day:02d}_' + 'TB_inputs' + '_final_UEs_' + str(
    final_number_of_ues) + '_Payload_' + str(payload_fq) + "_TTL_" + str(TTL) + '_TX_per_action_' + str(number_of_tx_data_per_step) + '_TTL_' + str(TTL) + '_goal_oriented_' + str(goal_oriented) + '_normalized_S_' + str(normalized_S) + "_discarded_pck" + "_skip_config_" + str(skip_config) + "_portion_time_1_over_" + str(skip_config_portion_time) +  '_Q_and_W_replay_not_split.txt'
